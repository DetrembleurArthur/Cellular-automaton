...
txtEdit = "EDITION MODE"
txtSouris = "mouse buttons: place or remove a cell"
txtC = "< c >: copy the current configuration"
txtV = "< v >: paste the current configuration"
txtG = "< g >: start simulation"
txtSim = "SIMULATION MODE"
txtR = "< r >: start edition mode (reset grid)"
txtS = "< s >: start edition mode with the current configuration"
txtP = "< p >: print/remove grid"
txtQ = "< q >: quit"
txtK = "< k >: save the current configuration in a picture"
